#!/usr/bin/env bash
# ============================================================================
#  DSV4 serve - NODE 1 (WORKER, --headless) on 80.5.5.60
...
#  Run AFTER node0 (master) is launching:   bash test_bench/serve_node1_60.sh
# ============================================================================
...
# ---- node-specific ---------------------------------------------------------
NODE_RANK=1
MASTER_ADDR=80.5.5.136     # worker connects to the MASTER (136), do NOT change to 60
MASTER_PORT=29501

# ---- CANN (NODE 1 / 60 uses its own CANN9.0.0_full set_env scripts) --------
echo "[cann] sourcing CANN9.0.0_full set_env scripts"
source /home/f00518697/m84379596/CANN/CANN9.0.0_full/ascend-toolkit/set_env.sh
source /home/f00518697/m84379596/CANN/CANN9.0.0_full/nnal/atb/set_env.sh
...
# ===========================================================================
#  RUNTIME ENV  (must match node0 exactly)
# ===========================================================================
...
# ===========================================================================
echo "[run] $VLLM serve  (node-rank $NODE_RANK, --headless, master $MASTER_ADDR:$MASTER_PORT)"
